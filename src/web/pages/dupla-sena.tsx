      ...
      <div className="relative z-10">
        ...
        <div className="mb-3">
          <TermometroAgressividade 
            nivel={calcularNivelAgressividade(bolao.jogosGerados, bolao.dezenas, "dupla-sena")}
            colorScheme={bolao.isVirada ? "orange" : "violet"}
          />
        </div>
        ...
        <div className="mt-4 flex items-center justify-center gap-3">
          ...
          <div className={`flex items-center gap-1 bg-bolao-dark/50 rounded-lg border ${
            bolao.isVirada ? "border-orange-500/30" : "border-purple-500/30"
          }`}>
            <Button
              variant="ghost"
              size="sm"
              ...
              className={`h-8 w-8 p-0 rounded-l-lg ${
                bolao.isVirada ? "hover:bg-orange-500/20" : "hover:bg-purple-500/20"
              }`}
            >
