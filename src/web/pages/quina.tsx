      ...
      <div className="relative z-10">
        ...
        <div className="mb-3">
          <TermometroAgressividade 
            nivel={calcularNivelAgressividade(bolao.jogosGerados, bolao.dezenas, "quina")}
            colorScheme="sky"
          />
        </div>
        ...
        <div className="mt-4 flex items-center justify-center gap-3">
          ...
          <div className="flex items-center gap-1 bg-bolao-dark/50 rounded-lg border border-sky-500/30">
            <Button
              variant="ghost"
              size="sm"
              onClick={() => setQuantidade(Math.max(1, quantidade - 1))}
              disabled={!isBolaoAvailable || quantidade <= 1}
              className="h-8 w-8 p-0 hover:bg-sky-500/20 rounded-l-lg"
            >
            ...
            <Button
              ...
              className="h-8 w-8 p-0 hover:bg-sky-500/20 rounded-r-lg"
            >
        ...
        <div className="mt-4 flex gap-2">
          <Button 
            ...
            variant="outline"
            className="flex-1 border-sky-500/50 text-sky-300 hover:bg-sky-500/10 hover:border-sky-400 font-semibold gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
  ...
  return (
    <Card className="relative overflow-hidden bg-gradient-to-br from-bolao-card/90 to-bolao-card/60 border-2 border-orange-500/60 hover:border-orange-400 transition-all duration-300 card-hover group">
      ...
      <div className="relative z-10 p-5">
        ...
        <div className="mt-4 flex items-center justify-center gap-3">
          <span className="text-sm text-muted-foreground">Qtd. Cotas:</span>
          <div className="flex items-center gap-1 bg-bolao-dark/50 rounded-lg border border-orange-500/30">
            <Button
              variant="ghost"
              size="sm"
              onClick={() => setQuantidade(Math.max(1, quantidade - 1))}
              disabled={!isBolaoAvailable || quantidade <= 1}
              className="h-8 w-8 p-0 hover:bg-orange-500/20 rounded-l-lg"
            >
              <Minus className="w-4 h-4" />
            </Button>
            <span className="w-10 text-center font-bold text-white">{quantidade}</span>
            <Button
              ...
              onClick={() => setQuantidade(quantidade + 1)}
              disabled={!isBolaoAvailable}
              className="h-8 w-8 p-0 hover:bg-orange-500/20 rounded-r-lg"
            >
              <Plus className="w-4 h-4" />
            </Button>
          </div>
        ...
        <div className="mt-4 flex gap-2">
          <Button 
            ...
            disabled={!isBolaoAvailable || isAddingToCart}
            variant="outline"
            className="flex-1 border-orange-500/50 text-orange-300 hover:bg-orange-500/10 hover:border-orange-400 font-semibold gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <ShoppingCart className="w-4 h-4" />
            {isAddingToCart ? "Adicionando..." : "Carrinho"}
          </Button>
